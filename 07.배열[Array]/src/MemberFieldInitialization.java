...
public class MemberFieldInitialization {
	/*
	 * 1-1.인스턴스멤버필드(변수)는 객체생성시 기본값으로 자동초기화
	 */
	...
	public Account member66=new Account(6666, "육육육",600000, 6.6);
	 ...
	 * 1-3.생성자초기화
	 */
	public MemberFieldInitialization(int member1, double member2, char member3, boolean member4, String member5,Account member6,
									int member11, double member22, char member33, boolean member44, String member55,Account member66) {
