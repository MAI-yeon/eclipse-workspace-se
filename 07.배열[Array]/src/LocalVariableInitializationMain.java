...
public class LocalVariableInitializationMain {
	...
	public static void main(String[] args) {
        ...
        /*
         * The local variable tot1 may not have been initialized(오류)
         *
		 * int tot1;
        ...
        /*
         * The local variable tot2 may not have been initialized
         *
         * int tot2;
        ...
        */
        ...
        /*
        The local variable account1 may not have been initialized(오류)
        Account account1;
        account1.print();
        */
        ...
        /*
        The local variable account2 may not have been initialized(오류)
        Account account2;
