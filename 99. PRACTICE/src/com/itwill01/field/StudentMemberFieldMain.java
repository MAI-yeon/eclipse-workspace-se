...
public class StudentMemberFieldMain {
	...
	public static void main(String[] args) {
		...
		if(student1.avg >= 90 && student1.avg <=100) {
			student1.gradePoint = 'A';
		}else if (student1.avg >= 90 && student1.avg <=100) {
			student1.gradePoint = 'B';
		}else if (student1.avg >= 90 && student1.avg <=100) {
			student1.gradePoint = 'C';
		}else if (student1.avg >= 90 && student1.avg <=100) {
			student1.gradePoint = 'D';
		}else {
			student1.gradePoint = 'F';
		}
		...
		*/
		System.out.printf("--------------학생 성적출력-------------------%n");
			...
			System.out.printf("-----------------------------------------------%n");
			System.out.printf("%3d %4s %4d %4d %4d %4d %4.1f %3c %4d%n",student1.studentNumber,student1.name, student1.kor,student1.eng,student1.math,student1.tot,student1.avg,student1.gradePoint,student1.rank);
			System.out.printf("%3d %4s %4d %4d %4d %4d %4.1f %3c %4d%n",student2.studentNumber,student2.name, student2.kor,student2.eng,student2.math,student2.tot,student2.avg,student2.gradePoint,student2.rank);
	}
