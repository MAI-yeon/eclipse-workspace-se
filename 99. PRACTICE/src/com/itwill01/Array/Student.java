   ...
   public class Student {
   	...
   	*/
   	...
   	public static void headerPrint1() {
   		System.out.printf("---------------학생 성적출력-------------------%n");
   		System.out.printf("%s %s %s %s %s %s %3s %s %s%n", "학번", "이름", "국어", "영어", "수학", "총점", "평균", "평점", "석차");
   		System.out.printf("-----------------------------------------------%n");

   	}
	public static void headerPrint2() {
   		System.out.printf("------------------------------%n");
   		System.out.printf("%s %s %3s %s %s%n","학번", "이름","총점", "  평균", "  평점");
   		System.out.printf("------------------------------%n");
   	...
   	public void print2() {
   		System.out.printf("%2d %5s %5d %7.1f %5c\n",this.no, this.name,this.tot, this.avg, this.grade);
